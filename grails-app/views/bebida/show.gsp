...
<html>
    ...
    <body>
        ...
        <div id="show-bebida" class="content scaffold-show" role="main">
            ...
            <f:display bean="bebida" />
            <g:form resource="${this.bebida}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.bebida}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
