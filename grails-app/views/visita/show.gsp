...
<html>
    ...
    <body>
        ...
        <div id="show-visita" class="content scaffold-show" role="main">
            ...
            <f:display bean="visita" />
            <g:form resource="${this.visita}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.visita}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
