...
<html>
    ...
    <body>
        ...
        <div id="show-musica" class="content scaffold-show" role="main">
            ...
            <f:display bean="musica" />
            <g:form resource="${this.musica}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.musica}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
